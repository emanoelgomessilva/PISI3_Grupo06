...
st.write('''Relação entre o sexo masculino e feminino que possui algum problema cardíaco nos dados utilizados''', unsafe_allow_html=True)
...
def grafico_barra():
    ...
    contagem.index = ['Masculino', 'Feminino']
